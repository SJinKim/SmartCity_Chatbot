...
if os.path.exists("../# Drafts/data_recursive"):
    # Ja: gespeicherter Vectorestore wird geladen
    loaded_faiss_vectorstore = FAISS.load_local("../# Drafts/data_recursive", embeddings)

    # Optional: Indexe im gespeicherten Vectorestore prüfen
    index_path = os.path.join("../# Drafts/data_recursive", "index.faiss")
