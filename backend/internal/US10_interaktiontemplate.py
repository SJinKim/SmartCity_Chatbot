...
def Interaktion_prompt(sachverhalt, original_text, user_query):
    prompt_template = PromptTemplate.from_template(
        """ Du bist Sachbearbeiter und Verfasser eines juristischen Gutachtens.
            Anhand einen Sachverhalt wird ein originaler Bescheid wie folgendes generiert. 
            sachverhalt : {sac}
            originaler Bescheid : {original}
            Auf Basis von Fragen oder Kommentare von den Benutzer solltest du einen neuen Text verfassen.
