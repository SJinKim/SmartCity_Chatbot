...
def erstelleGutachten(sachverhalt, gutachten_path)->str:
    ...
    gutachten_response = chain.run(input_documents=sachverhalt, question=gutachten_query, context=loaded_gutachten)
...
def erstelleBescheid(sachverhalt, gutachten_result, bescheid_path)->str:
    ...
    bescheid_response = chain.run(input_documents=similar_bescheid, question=bescheid_query, context=sachverhalt)
